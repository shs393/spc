...
function call($addr) {
    ...
    $c = curl_init("https://www.spacemining.io/");
    curl_setopt($c, CURLOPT_REFERER, "https://www.spacemining.io/");
...
for($i=0; $i<100; $i++) {
    echo "[" . date("H:i:s") . "] claim and wait...\n";
    $claim = call($btc);
    //print_r($claim);
    ...
    if (isset($claim['info'])) {
        ...
        if ($claim['status'] == 1) {
            echo $GR . "[" . date("H:i:s") . "]  Berhasil ! " . $claim ['message'] . $CC . "\n";
